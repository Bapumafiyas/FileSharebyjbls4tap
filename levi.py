    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL_1:
            try:
                ...
                self.LOGGER(__name__).info("\Bot Stopped. Join @JBL_TOXIC for support")
                sys.exit()
        ...
        self.LOGGER(__name__).info(f"Bot Running..!\Created by \@JBL_TOXIC")
        self.LOGGER(__name__).info(f"Developer:- @JBL_TOXIC")
